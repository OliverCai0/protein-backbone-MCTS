...
keys = np.load(open("/opt/conda/envs/env/getpy_motif/motif_dict_1.0_15_-1.0_H-H_keys.dump", 'rb'), allow_pickle=False)
values = np.load(open("/opt/conda/envs/env/getpy_motif/motif_dict_1.0_15_-1.0_H-H_values.dump", 'rb'), allow_pickle=False)
motif_dict[keys] = values
del keys
del values

motif_masks = np.load(open("/opt/conda/envs/env/getpy_motif/motif_array_1.0_15_-1.0_H-H.dump", 'rb'), allow_pickle=False)
...
npose_dir = "/opt/conda/envs/env/npose"
