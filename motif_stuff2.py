...
import fmh.future_hash_motif as fmh
...
def motif_score_npose( npose, care_mask=None, calc_mask=None ):
    ...
    who_is = np.arange(nu.nsize(npose), dtype=int)[calc_mask]
...
def motif_score_npose_asym( npose1, npose2 ):
    ...
    who_is1 = np.arange(nu.nsize(npose1), dtype=int)
    who_is2 = np.arange(nu.nsize(npose2), dtype=int)
